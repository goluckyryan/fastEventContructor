...
# ./EventBuilder test.root 1000 1 `\ls -1 ../data/*run_040*`
# ./EventBuilder_Q test_Q.root 1000 1 `\ls -1 ../data/*run_040*`
./EventBuilder_S test_S.root 1000 1 10 `\ls -1 ../data/*run_040*`
